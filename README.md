...
doc = ClinicalDocument.load(
    "tests/data/CNAM-HR_2021.01.xml"
)  # doc is an instance of ClinicalDocument
...
doc.component.content[2].tables[
    0
].headers  # -> ['Date de délivrance', 'Libellé du vaccin', 'Valence vaccinale', 'Prescrit par', 'Spécialité du prescripteur', 'Établissement du prescripteur', 'Délivré par']
